                ...
                <div class="section__content section__content--p30">
                  <div class="row mt-0 mb-2">
                    ...
                    <form action="{{ route('gud.store') }}" method="POST">
                        @csrf
                        <div class="mb-1"><h4> Tanggal </h4></div>
                        <div class="form-group mb-2">
                            <input type="date" class="form-control" id="Tanggal" name="Tanggal">
                          </div>
                          <div class="mb-1"><h4> Nama Pegawai </h4></div>
                          ...
                          <div class="mb-1"><h4> Nama Barang </h4></div>
                          <select class="form-select mb-2"1id="NamaBarang" name="NamaBarang" aria-label="Default select example">
                            <option value="Kertas A4">Kertas A4</option>
                            <option value="Ballpoint">Ballpoint</option>
                            <option value="Sapu">Sapu</option>
                          </select>
                          <div class="mb-1"><h4> Jumlah Barang </h4></div>
                          <div class="form-floating mb-2">
                            <input type="text" class="form-control" id="Jumlah" placeholder="Jumlah Barang" name="Jumlah">
                            <label for="jumlah" class="form-label">Jumlah Barang</label>
                          </div>
                          <div class="mb-1"><h4> Unit Kerja </h4></div>
                          <select class="form-select mb-2" id="UnitKerja" name="UnitKerja" aria-label="Default select example">
                            <option value="SBM">SBM</option>
                            <option value="Kurikulum">Kurikulum</option>
                            <option value="Kesiswaan">Kesiswaan</option>
                          </select>
                          <div class="mb-1"><h4> Keterangan </h4></div>
                          <div class="form-floating mb-2">
